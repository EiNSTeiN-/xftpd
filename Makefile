...
XFTPD_OBJECTS =  asprintf.o base64.o config.o crypto.o io.o logging.o main.o \
				 ...
				 nuke.o service.o asynch.o obj.o crc32.o
...
xFTPd.exe: $(LUABIND_OBJECTS) $(XFTPD_OBJECTS)
	$(GCC) -o xFTPd.exe $(LUABIND_OBJECTS) $(XFTPD_OBJECTS) -lws2_32 -lcrypto -lgdi32 -llua -ltolua -llualib -lz

slave.exe: $(SLAVE_OBJECTS)
	$(GCC) -o slave.exe $(SLAVE_OBJECTS) -lws2_32 -lcrypto -lgdi32 -lz

proxy.exe: $(PROXY_OBJECTS)
	$(GCC) -o proxy.exe $(PROXY_OBJECTS) -lws2_32
